<template>
    <nav class="bg-white">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-between">
                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4 float-right">
                            <a href="/instanthelp" class="text-black px-3 py-6 text-md font-bold border-b-3 border-yellow-500" :class="activeClass=='instanthelp'?'active_menu':''">GET INSTANT HELP</a>

                            <a href="/helpclients" class="text-black px-3 py-6 text-md font-bold" :class="activeClass=='helpclients'?'active_menu':''">HELP CLIENTS</a>
        ...
        <div class="sm:hidden" id="mobile-menu">
            ...
            <a href="/instanthelp" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">GET INSTANT HELP</a>

            <a href="/helpclients" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">HELP CLIENTS</a>

            <a href="/message" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                <img src="../assets/CHAT.png" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" alt="">
            </a>
